...
import com.example.woof.databinding.ActivityDoctorBinding
import com.example.woof.databinding.ActivitySellerBinding
...
class SellerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarSeller.toolbar.title = ""
        setSupportActionBar(binding.appBarSeller.toolbar)
        ...
        val drawerLayout: DrawerLayout = binding.drawerLayoutSeller
        val navView: NavigationView = binding.navViewSeller
