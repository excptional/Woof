...
class DoctorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.appBarDoctor.toolbar.title = ""
        ...
        val drawerLayout: DrawerLayout = binding.drawerLayoutDoctor
        val navView: NavigationView = binding.navViewDoctor
        val navController = findNavController(R.id.nav_host_fragment_content_doctor)
